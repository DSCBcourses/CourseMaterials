...
VirgSeto <- iris %>% filter(Species == "virginica" | Species == "setosa")
...
```{r}
Sepal_petal <- lm(Sepal.Length ~ Petal.Length, data = virginica)

plot(x=virginica$Petal.Length, y=virginica$Sepal.Length)
abline(Sepal_petal)
```
...
**Test 4**:  Is there a difference in mean petal length between virginica and either of the other two species?
...
**Test 5**:  Is there a difference in mean petal length among any of the species?
